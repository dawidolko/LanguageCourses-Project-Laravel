...
@include('layouts.head', [
    'pageTitle' => '503 - Serwis chwilowo niedostępny | languageCourses',
    'metaDescription' => 'Prowadzimy prace techniczne. Wróć za kilka minut - powinno już działać.',
    ...
    <div class="lc-shell">
        <div class="lc-error">
            <div class="lc-error-inner">
                ...
                <p class="lc-error-code" aria-hidden="true">503</p>

                <h1>Serwis chwilowo niedostępny</h1>

                <p>Prowadzimy prace techniczne. Wróć za kilka minut - powinno już działać.</p>
