...
@include('layouts.head', [
    'pageTitle' => '401 - Wymagane logowanie | languageCourses',
    'metaDescription' => 'Ta strona jest dostępna tylko dla zalogowanych użytkowników.',
    ...
    <div class="lc-shell">
        <div class="lc-error">
            <div class="lc-error-inner">
                ...
                <p class="lc-error-code" aria-hidden="true">401</p>
